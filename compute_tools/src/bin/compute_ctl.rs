...
struct Cli {
    ...
    #[arg(short = 's', long = "spec", group = "spec", env = "SPEC_JSON")]
    pub spec_json: Option<String>,

    #[arg(short = 'S', long, group = "spec-path", env = "SPEC_PATH")]
    pub spec_path: Option<OsString>,

    #[arg(short = 'i', long, group = "compute-id", conflicts_with_all = ["spec", "spec-path"])]
    pub compute_id: Option<String>,

    #[arg(short = 'p', long, conflicts_with_all = ["spec", "spec-path"], requires = "compute-id", env = "CONTROL_PLANE_API_BASE_URL")]
